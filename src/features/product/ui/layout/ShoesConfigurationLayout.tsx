...
import { ProductShoes } from "../../types/product";
...
const ShoesConfigurationLayout = () => {
  ...
  const updateShoesSizeReduction = (id: number, discountID: number) => {
    // fetch data from API
    fetch(`http://localhost:3000/shoessize/${id}`, {
      method: "PATCH",
      headers: {
                            ...
                            <div>
                              {discount.DiscountID === item.DiscountID ? (
                                <>
                                  ...
                                  <div>
                                    {selectedShoesSize === item.ShoesSizeID &&
                                      visible && (
                                        <>
                                          <select
                                            name="DiscountID"
                          ...
                          <div>
                            <button
                              ...
                              onClick={() => {
                                setVisible(!visible);
                                console.log(item.ShoesSizeID);
                                setSelectedShoesSize(item.ShoesSizeID);
                              }}
                            >
                              Modifier
                            </button>
